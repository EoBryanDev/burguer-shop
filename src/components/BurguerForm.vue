<template>
    <div>
        ...
        <div>
            <form id="burguer-form" @submit="criarHamburguer($event)">
    ...
    export default {
        ...
        methods : {
            ...
            async getIngredientes(){
                const req = await fetch("https://fake-api-burguer-shop.herokuapp.com/ingredientes");
            ...
            async criarHamburguer(e){
                ...
                e.preventDefault();
                 console.log(this.idPedido + 'before')
                this.idPedido = uniqid()
                console.log(this.idPedido + 'after')
                const data = {
                    nome: this.nome,
                    pao: this.pao,
                    carne: this.carne,
